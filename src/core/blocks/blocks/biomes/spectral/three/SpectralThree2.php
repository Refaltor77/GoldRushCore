...
final class SpectralThree2 extends Tree{
    ...
    public function __construct(){
        parent::__construct(CustomiesBlockFactory::getInstance()->get("goldrush:spectral_log"), CustomiesBlockFactory::getInstance()->get("goldrush:spectral_leaves"), 12);
    }
