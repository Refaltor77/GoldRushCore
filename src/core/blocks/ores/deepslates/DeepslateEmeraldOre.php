...
class DeepslateEmeraldOre extends Opaque
{
    ...
    public function onBreak(Item $item, ?Player $player = null, array &$returnedItems = []): bool
    {
        if ($player instanceof CustomPlayer) {
            ...
            $bool = Main::getInstance()->getJobsManager()->addXp($player, JobsManager::MINOR, 25);
            if ($bool )Main::getInstance()->getJobsManager()->xpNotif($player, $this->getPosition(), 25, JobsManager::MINOR);
