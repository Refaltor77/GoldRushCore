...
class EmeraldChestTile extends Spawnable implements Container, Nameable{
    ...
    protected EmeraldChestInventory $inventory;


    public function __construct(World $world, Vector3 $pos){
        parent::__construct($world, $pos);
        $this->inventory = new EmeraldChestInventory(72, "emerald_chest");
    }
    ...
    public function getInventory() : EmeraldChestInventory{
        return $this->inventory;
    }

    public function getRealInventory() : EmeraldChestInventory{
        return $this->inventory;
    }
