...
use core\inventory\PlatinumChestInventory;
...
class PlatinumChestTile extends Spawnable implements Container, Nameable{
    ...
    protected PlatinumChestInventory $inventory;


    public function __construct(World $world, Vector3 $pos){
        parent::__construct($world, $pos);
        $this->inventory = new PlatinumChestInventory(120, "platinum_chest");
    }
    ...
    public function getInventory() : PlatinumChestInventory{
        return $this->inventory;
    }

    public function getRealInventory() : PlatinumChestInventory{
        return $this->inventory;
    }


    public function getDefaultName() : string{
        return "platinum_chest";
    }
