...
trait EnchantmentTrait{
    ...
    public function isItemCompatible(Item $item): bool{
        return $item instanceof Armor || $item instanceof Tool || $item instanceof Shovel || in_array($item->getTypeId(), [
                ItemTypeIds::FISHING_ROD, ItemTypeIds::BOW,
                ItemTypeIds::SHEARS, ItemTypeIds::FLINT_AND_STEEL,
            ]);
    }
