...
class BoxFortune extends Entity
{
    ...
    public function __construct(Location $location, ?CompoundTag $nbt = null)
    {
        ...
        $this->setNameTag("§6- §fFortune" . TextFormat::MINECOIN_GOLD . "Box §6-\n\n§7§oTape moi");
        $location->pitch = 0.0;
        ...
        $inv->setName("fortune_box");
        $inv->setContents(array_values(Main::getInstance()->getBoxManager()->getItemsWithBox(BoxManager::FORTUNE)));
        $this->inv = $inv;
    ...
    {
        $key = CustomiesItemFactory::getInstance()->get(Ids::KEY_FORTUNE);
        ...
        if ($damager instanceof Player) {
            ...
            $damager->getServer()->dispatchCommand($damager, "open_box fortune");
            return;
            ...
            Main::getInstance()->getScheduler()->scheduleDelayedTask(new ClosureTask(function () use ($player): void {
                $this->setNameTag("§6- §fBox Fortune §6-\n\n§7§oTape moi");
