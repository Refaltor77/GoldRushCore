...
class BoxLegendary extends Entity
{
    ...
    public function __construct(Location $location, ?CompoundTag $nbt = null)
    {
        ...
        $this->setNameTag("§6- §fLegendary" . TextFormat::MINECOIN_GOLD . "Box §6-\n\n§7§oTape moi");
        $location->pitch = 0.0;
        ...
        $inv->setName("legendary_box");
        $inv->setContents(array_values(Main::getInstance()->getBoxManager()->getItemsWithBox(BoxManager::LEGENDARY)));
        $this->inv = $inv;
    ...
    {
        $key = CustomiesItemFactory::getInstance()->get(Ids::KEY_LEGENDARY);
        ...
        if ($damager instanceof Player) {
            ...
            $damager->getServer()->dispatchCommand($damager, "open_box legendary");
            return;
            ...
            Main::getInstance()->getScheduler()->scheduleDelayedTask(new ClosureTask(function () use ($player): void {
                $this->setNameTag("§6- §fBox Legendary §6-\n\n§7§oTape moi");
