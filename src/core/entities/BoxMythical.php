...
use goldrush\setting\ModdedIds;
...
class BoxMythical extends Entity
{
    ...
    public function __construct(Location $location, ?CompoundTag $nbt = null)
    {
        ...
        $this->setNameTag("§6- §fMythical" . TextFormat::DARK_PURPLE . "Box §6-\n\n§7§oTape moi");
        $location->pitch = 0.0;
        ...
        $inv->setName("mythical_box");
        $inv->setContents(array_values(Main::getInstance()->getBoxManager()->getItemsWithBox(BoxManager::MYTHICAL)));
        $this->inv = $inv;
    ...
    {
        $key = CustomiesItemFactory::getInstance()->get(Ids::KEY_MYTHICAL);
        ...
        if ($damager instanceof Player) {
            ...
            $damager->getServer()->dispatchCommand($damager, "open_box mythical");
            return;
            ...
            Main::getInstance()->getScheduler()->scheduleDelayedTask(new ClosureTask(function () use ($player): void {
                $this->setNameTag("§6- §fBox Mythical §6-\n\n§7§oTape moi");
