...
class BoxBlackGold extends Entity
{
    ...
    public function __construct(Location $location, ?CompoundTag $nbt = null)
    {
        ...
        $this->setNameTag("§6- §fBox" . TextFormat::LIGHT_PURPLE . " Cosmétiques §6-\n\n§7§oTape moi");
        $location->pitch = 0.0;
        ...
        $inv->setName("black_gold_box");
        $inv->setContents(array_values(Main::getInstance()->getBoxManager()->getItemsWithBox(BoxManager::BLACK_GOLD)));
        $this->inv = $inv;
    ...
    {
        $key = CustomiesItemFactory::getInstance()->get(Ids::KEY_BLACK_KEY);
        ...
        if ($damager instanceof Player) {
            ...
            $damager->getServer()->dispatchCommand($damager, "open_box black_gold");
            return;
            ...
            Main::getInstance()->getScheduler()->scheduleDelayedTask(new ClosureTask(function () use ($player): void {
                $this->setNameTag("§6- §fBox Black Gold §6-\n\n§7§oTape moi");
    ...
    {
        return 'goldrush:box_black_gold';
    }
