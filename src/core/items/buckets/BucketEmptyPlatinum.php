...
class BucketEmptyPlatinum extends Bucket implements ItemComponents
{
    ...
    public function __construct(ItemIdentifier $identifier)
    {
        ...
        $this->initComponent('bucket_empty_platinum', $inventory);
    ...
    public function onInteractBlock(Player $player, Block $blockReplace, Block $blockClicked, int $face, Vector3 $clickVector, array &$returnedItems): ItemUseResult
    {
        ...
        if ($blockReplace instanceof Liquid && $blockReplace->isSource()) {
            if ($blockReplace instanceof Water || $blockReplace instanceof Lava) {
                ...
                $player->getInventory()->setItemInHand(CustomiesItemFactory::getInstance()->get($this->getNamedTag()->getString("type") === "water" ? Ids::BUCKET_PLATINUM_WATER : Ids::BUCKET_PLATINUM_LAVA)->setNamedTag($this->getNamedTag()));
