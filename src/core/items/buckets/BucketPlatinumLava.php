...
class BucketPlatinumLava extends Bucket implements ItemComponents
{
    ...
    {
        $name = 'Seau en platine remplie de lave';
        ...
        $this->initComponent('bucket_platinum_lava', $inventory);
