...
class UraharaKeisukeBob extends Item implements ItemComponents
{
    ...
    public function __construct(ItemIdentifier $identifier)
    {
        ...
        parent::__construct($identifier, self::$nameString = "§6- §fBob " . TextFormat::RED . "Urahara Keisuke §6-");
    ...
    {
        return Ids::URAHARA_KEISUKE_BOB;
    }
}