...
class BerryBlack extends Food implements ItemComponents
{
    ...
    public function __construct(ItemIdentifier $identifier)
    {
        ...
        $this->initComponent('berry_black', $inventory);
        $this->addComponent(new FoodComponent(false));
        $this->addComponent(new UseAnimationComponent(UseAnimationComponent::ANIMATION_EAT));

        $this->setLore([
            "§6---",
            "§l§eDescription:§r§f Une délicieuse baie noir, symbole de fraîcheur et de gourmandise.",
            "§6---",
            "§l§eUtilité:§r§f Idéale pour la production d'alcool de force.",
            "§r§6---",
    ...
    {
        return CustomiesBlockFactory::getInstance()->get(Ids::BERRY_BLACK_CROPS_STAGE_0);
    }
