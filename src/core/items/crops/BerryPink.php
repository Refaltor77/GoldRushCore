...
class BerryPink extends Food implements ItemComponents
{
    ...
    public function __construct(ItemIdentifier $identifier)
    {
        ...
        $this->initComponent('berry_pink', $inventory);
        $this->addComponent(new FoodComponent(false));
        $this->addComponent(new UseAnimationComponent(UseAnimationComponent::ANIMATION_EAT));

        $this->setLore([
            "§6---",
            "§l§eDescription:§r§f Une délicieuse baie rose, symbole de fraîcheur et de gourmandise.",
            "§6---",
            "§l§eUtilité:§r§f Idéale pour la production d'alcool de soins.",
            "§r§6---",
    ...
    {
        return CustomiesBlockFactory::getInstance()->get(Ids::BERRY_PINK_CROPS_STAGE_0);
    }
