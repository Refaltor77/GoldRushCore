...
class AmethystDynamite extends ProjectileItem implements ItemComponents
{
    use ItemComponentsTrait;

    public function __construct(ItemIdentifier $identifier)
    {
        $name = "Dynamite en améthyste";
        ...
        $this->initComponent('amethyst_dynamite', $inventory);

        $this->setLore([
            "§6---",
            "§l§eDescription:§r§f Dynamite en améthyste - puissante et redoutable,\nelle instaure la peur dans le regard de vos\nennemies et elle fait sauter les murs les plus solides",
            "§6---",
    ...
    {
        return new \core\entities\dynamites\AmethystDynamite($location, $thrower);
    }
