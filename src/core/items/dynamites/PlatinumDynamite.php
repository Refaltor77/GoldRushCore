...
class PlatinumDynamite extends ProjectileItem implements ItemComponents
{
    use ItemComponentsTrait;

    public function __construct(ItemIdentifier $identifier)
    {
        $name = "Dynamite en platine";
        ...
        $this->initComponent('platinum_dynamite', $inventory);

        $this->setLore([
            "§6---",
            "§l§eDescription:§r§f Dynamite en platine - extra puissante et vicieuse,\nelle fais peur à la mort, à vos\nennemies et elle fait sauter les murs les plus solides",
            "§6---",
    ...
    {
        return new \core\entities\dynamites\PlatineDynamite($location, $thrower);
    }
}