...
class HorseArmorCopper extends Item implements ItemComponents
{
    use ItemComponentsTrait;

    public function __construct(ItemIdentifier $identifier)
    {
        $name = 'Monture en cuivre';
        ...
        $this->initComponent('monture_cuivre', $inventory);

        $this->setLore([
            "§6---",
            "§l§eDescription:§r§f La monture en cuivre, fidèle compagnon\nil vous accompagnera jusqu'au plus profond du\nmonde de Goldrush.",
            "§6---",
            "§l§eVitesse: §l1",
            "§6---",
    ...
    public function onClickAir(Player $player, Vector3 $directionVector, array &$returnedItems): ItemUseResult
    {
        ...
        Main::getInstance()->getScheduler()->scheduleRepeatingTask(new SpawnHorseTask($player, 1.8, $this), 20);
        return parent::onClickAir($player, $directionVector, $returnedItems);
    }
}