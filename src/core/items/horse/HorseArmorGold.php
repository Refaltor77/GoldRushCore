...
class HorseArmorGold extends Item implements ItemComponents
{
    ...
    public function __construct(ItemIdentifier $identifier)
    {
        ...
        $this->initComponent('monture_gold', $inventory);

        $this->setLore([
            "§6---",
            "§l§eDescription:§r§f La monture en or, fidèle compagnon\nil vous accompagnera jusqu'au plus profond du\nmonde de Goldrush.",
            "§6---",
            "§l§eVitesse: §l3",
            "§6---",
    ...
    public function onClickAir(Player $player, Vector3 $directionVector, array &$returnedItems): ItemUseResult
    {
        ...
        Main::getInstance()->getScheduler()->scheduleRepeatingTask(new SpawnHorseTask($player, 1, $this), 20);
        return parent::onClickAir($player, $directionVector, $returnedItems);
    }
}