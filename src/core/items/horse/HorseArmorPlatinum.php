...
class HorseArmorPlatinum extends Item implements ItemComponents
{
    use ItemComponentsTrait;

    public function __construct(ItemIdentifier $identifier)
    {
        $name = 'Monture en platine';
        ...
        $this->initComponent('monture_platine', $inventory);

        $this->setLore([
            "§6---",
            "§l§eDescription:§r§f La monture en platine, fidèle compagnon\nil vous accompagnera jusqu'au plus profond du\nmonde de Goldrush.",
            "§6---",
            "§l§eVitesse: §l2",
            "§6---",
