...
class BoneAxe_12 extends AbstractWoodenAxe
{
    ...
    {
        return VanillaItems::NETHERITE_AXE()->getAttackPoints() + 1;
    }
    ...
    {
        return VanillaItems::NETHERITE_AXE()->getBaseMiningEfficiency() + 1;
    }
