...
class BoneAxe_13 extends AbstractWoodenAxe
{
    ...
    {
        return VanillaItems::NETHERITE_AXE()->getAttackPoints() + 2;
    }
    ...
    {
        return VanillaItems::NETHERITE_AXE()->getBaseMiningEfficiency() + 2;
    }
