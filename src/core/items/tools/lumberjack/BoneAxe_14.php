...
class BoneAxe_14 extends AbstractWoodenAxe
{
    ...
    {
        return VanillaItems::NETHERITE_AXE()->getAttackPoints() + 4;
    }
    ...
    {
        return VanillaItems::NETHERITE_AXE()->getBaseMiningEfficiency() + 4;
    }
