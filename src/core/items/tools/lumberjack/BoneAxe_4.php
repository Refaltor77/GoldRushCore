...
class BoneAxe_4 extends AbstractWoodenAxe
{
    ...
    {
        return VanillaItems::STONE_AXE()->getAttackPoints() + 1;
    }
    ...
    {
        return VanillaItems::DIAMOND_AXE()->getBaseMiningEfficiency() + 30;
    }
