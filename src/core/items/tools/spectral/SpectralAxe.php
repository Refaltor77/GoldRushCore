...
class SpectralAxe extends Axe implements ItemComponents
{
    ...
    public function __construct(ItemIdentifier $identifier)
    {
        ...
        $this->initComponent('spectral_axe', $inventory);
        ...
        $this->setLore([
            "§6---",
            "§l§eDescription:§r§f La hache spectral,\noutils fiable et solide",
            "§6---",
    ...
    {
        return VanillaItems::DIAMOND_AXE()->getMiningEfficiency(true) + 5;
    }
