...
class SpectralPickaxe extends Shovel implements ItemComponents
{
    ...
    public function __construct(ItemIdentifier $identifier)
    {
        ...
        $this->initComponent('spectral_pickaxe', $inventory);
        ...
        $this->setLore([
            "§6---",
            "§l§eDescription:§r§f La pioche spectral,\noutils fiable et solide",
            "§6---",
    ...
    {
        return VanillaItems::DIAMOND_SWORD()->getAttackPoints();
    }

    protected function getBaseMiningEfficiency(): float
    {
        return VanillaItems::DIAMOND_PICKAXE()->getMiningEfficiency(true) + 5;
    }
