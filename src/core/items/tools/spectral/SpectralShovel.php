...
class SpectralShovel extends Shovel implements ItemComponents
{
    ...
    public function __construct(ItemIdentifier $identifier)
    {
        ...
        $this->initComponent('spectral_shovel', $inventory);
        ...
        $this->setLore([
            "§6---",
            "§l§eDescription:§r§f La pelle spectral,\noutils fiable et solide",
            "§6---",
    ...
    {
        return VanillaItems::DIAMOND_SWORD()->getAttackPoints()  - 3;
    }

    protected function getBaseMiningEfficiency(): float
    {
        return VanillaItems::DIAMOND_SHOVEL()->getMiningEfficiency(true) + 5;
    }
