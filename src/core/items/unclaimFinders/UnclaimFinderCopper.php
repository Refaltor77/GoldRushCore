...
class UnclaimFinderCopper extends Axe implements ItemComponents
{
    use ItemComponentsTrait;

    public function __construct(ItemIdentifier $identifier)
    {
        $name = 'Unclaim finder en cuivre';
        ...
        $this->initComponent('copper_unclaim', $inventory);
