...
class UnclaimFinderEmerald extends Axe implements ItemComponents
{
    use ItemComponentsTrait;

    public function __construct(ItemIdentifier $identifier)
    {
        $name = 'Unclaim finder en émeraude';
        ...
        $this->initComponent('emerald_unclaim', $inventory);
        ...
        $this->setLore([
            "§6---",
            "§l§eDescription:§r§f L'unclaim finder en émeraude permet de\nrechercher des coffres dans un 2 chunks.",
            "§6---",
            "§eDurability: §f" . $this->getMaxDurability() . " ",
            "§eDistance: 2 chunks§f",
            "§6---",
